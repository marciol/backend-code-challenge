...
module Shipping
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['SHIPPING_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Shipping::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Shipping::Action is included
      ...
      # Configure the code that will yield each time Shipping::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Shipping::Assets::Helpers
      end
    end
